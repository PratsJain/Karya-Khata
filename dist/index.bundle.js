...
.sidebar-anim {
    animation: sidebar_items var(--anim-dur) ease-in-out var(--anim-delay) 1 both;
}
...
.topdown-animation {
    animation: topdowntrans var(--anim-dur) ease-in-out var(--anim-delay) 1 both;
}
